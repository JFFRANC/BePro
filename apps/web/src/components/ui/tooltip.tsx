    ...
    <TooltipPrimitive.Portal>
      ...
      >
        <TooltipPrimitive.Popup
          ...
          // Feature 009: tooltip 100ms fade-in (budget tight), 100ms fade-out.
          // Shadow mas suave para superficie invertida (foreground sobre bg).
          className={cn(
            "z-50 inline-flex w-fit max-w-xs origin-(--transform-origin) items-center gap-1.5 rounded-md bg-foreground px-2.5 py-1.5 text-xs text-background shadow-md",
